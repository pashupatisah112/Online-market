...
<style>
    ...
    strong{color:red;}
    .select2 select2-container select2-container--bootstrap4 select2-container--below{width:100%;padding: 10px;}
</style>
@endsection

<section>
    <div class="container">
            <h2>Create ad and sell your product</h2>
            ...
            @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" id="inputError" class="@error('title') is-invalid @enderror form-control" style="margin-bottom:10px;" name="title" value="{{ old('title')}}" placeholder="Title of your ad *">
                        @error('title')
                    ...
                    <div class="col-md-4">
                        <input type="text" class="@error('company') is-invalid @enderror form-control" style="margin-bottom:10px;" name="company" value="{{ old('company')}}" placeholder="Company of product">
                        @error('company')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" class="@error('price') is-invalid @enderror form-control" style="margin-bottom:10px;" name="price" value="{{ old('price')}}" placeholder="Enter your price *">
                        @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-4">
                        <select class="form-control" style="margin-bottom:10px;" name="city">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="myStreet" class="@error('street') is-invalid @enderror form-control" style="margin-bottom:10px;" name="street" value="{{ old('street')}}" placeholder="Street or Tole or Area *">
                        @error('street')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <select class="form-control" style="margin-bottom:10px;" name="condition">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" class="@error('charge') is-invalid @enderror form-control" style="margin-bottom:10px;" id="charge" name="charge" value="{{ old('charge')}}" placeholder="Delivery Charge">
                        @error('charge')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-4">
                        <select class="form-control" name="used_time" style="margin-bottom:10px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8" style="margin-bottom:10px;">
                        <textarea class="form-control" rows="7" name="description" placeholder="Enter ..."></textarea>
                    </div>
