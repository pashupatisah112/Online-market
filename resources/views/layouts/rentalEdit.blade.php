...
<section>
    <div class="container">
        <h2>Update Your Space Ads Info Here</h2>
        <form method="POST" action="{{ route('user-room.update',$rental->id) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
            <!-----hidden user field------>
            ...
            <div class="row">
                <div class="col-md-4">
                    <input type="text" style="margin-bottom:10px;" id="inputError" class="@error('title') is-invalid @enderror form-control" name="title" value="{{ $rental->title}}" placeholder="Title for your ad *">
                    @error('title')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input type="text" id="inputError" style="margin-bottom:10px;" class="@error('num_rooms') is-invalid @enderror form-control" name="num_rooms" value="{{ $rental->num_rooms}}" placeholder="No of Rooms *">
                    @error('num_rooms')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                <div class="col-md-4">
                    <input type="text" id="myStreet" style="margin-bottom:10px;" class="@error('street') is-invalid @enderror form-control" name="street" value="{{ $rental->street->street_name }}" placeholder="Street or Tole or Area *">
                    @error('street')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-4">
                    <input type="text" style="margin-bottom:10px;" class="@error('rent') is-invalid @enderror form-control" name="rent" value="{{ $rental->rent}}" placeholder="Rent Per Month *">
                    @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                <div class="col-md-4">
                    <select class="form-control" name="suitable_for" id="suitable_for" style="margin-bottom:10px;">
                ...
                <div class="col-md-8">
                    <div class="row" style="margin-bottom:10px;">
                        <div class="col-md-4">
                            <div class="form-check ml-2">
                                @if ($rental->drink_water == 'Yes')
                                    <input class='form-check-input' type='checkbox' name='water' value='Yes' id='water' checked>
                                @else
                        ...
                        <div class="col-md-4">
                            <div class="form-check ml-2">
                                @if ($rental->parking == 'Yes')
                                    <input class='form-check-input' type='checkbox' name='parking' value='Yes' id='parking' checked>
                                @else
                        ...
                        <div class="col-md-4">
                            <div class="form-check ml-2">
                                @if ($rental->shared_kitchen == 'Yes')
                                    <input class='form-check-input' type='checkbox' name='kitchen' value='Yes' id='kitchen' checked>
                                @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-check ml-2">
                              @if ($rental->shared_bathroom == 'Yes')
                                  <input class='form-check-input' type='checkbox' name='bathroom' value='Yes' id='bathroom' checked>
                              @else
                        ...
                        <div class="col-md-4">
                          <div class="form-check ml-2">
                              @if ($rental->bill_included == 'Yes')
                                  <input class='form-check-input' type='checkbox' name='bill' value='Yes' id='bill' checked>
                              @else
                        ...
                        <div class="col-md-4">
                          <div class="form-check ml-2">
                              @if ($rental->wifi == 'Yes')
                                  <input class='form-check-input' type='checkbox' name='wifi' value='Yes' id='wifi' checked>
                              @else
            ...
            <div class="row">
              <div class="col-md-8">
                <textarea class="form-control" rows="7" style="margin-bottom:10px;" name="description" placeholder="Enter ...">{{$rental->description}}</textarea>
              </div>
...
<script>
  ...
  <script type="text/javascript">
    var spaceType = "{{$rental->type}}";
    document.querySelector('#spaceType').value = spaceType;

    var flatType = "{{$rental->flat_type}}";
    document.querySelector('#flatType').value = flatType;

    var floor = "{{$rental->floor}}";
    document.querySelector('#floor').value = floor;

    var ad_duration = "{{$rental->ad_duration}}";
    document.querySelector('#ad_duration').value = ad_duration;

    var city = "{{$rental->city_id}}";
    document.querySelector('#city').value = city;
    
    var suitable_for = "{{$rental->suitable_for}}";
    document.querySelector('#suitable_for').value = suitable_for;
    </script>
<script>
